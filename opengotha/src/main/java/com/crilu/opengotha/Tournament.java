...
public class Tournament implements TournamentInterface, java.io.Serializable {
     ...
     */
    @Override
    public boolean removePlayer(Player player) throws TournamentException {
     ...
     */
    @Override
    public Player getPlayerByKeyString(String strNaFi) {
...
//            Game g = new Game(roundNumber, -1, null, null, true, 0, Game.RESULT_UNKNOWN);
     ...
     */
    private void fillBaseScoringInfoIfNecessary() {
    ...
    private void setChangeSinceLastSave(boolean changeSinceLastSave) {
